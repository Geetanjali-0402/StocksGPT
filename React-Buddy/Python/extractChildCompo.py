...
def childComponents(file_path):
    ...
    Find all the child Components that are being used in the above code without taking into account those components which are under node
